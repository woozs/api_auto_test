...
if __name__ == "__main__":
    a = {"auth": {"scope": {"${key}$": {"domain":{"id": "default"},"name": "${project_token_name}$"}}, "identity":{"password": {"user": {"domain":{"id": "default"},"password":"admin","name":"admin"}},"methods":["password"]}}}
    b = {"key": ["123", "321"], "project_token_name": "test"}
    print(manage(a, b))
    ...
    # d = ConfRelevance.ConfRelevance(CONF_PATH,"test_data").get_relevance_conf()
    # print(manage(a, d))