...
from common import config_http, host_manage, read_param, param_manage
...
def send_request(data, host, address, port, relevance, _path, success):
    ...
    parameter = read_param.read_param(
        data["test_name"],
        data["parameter"],
        relevance,
        _path,
        ...
        'check': [
            {
                ...
                'expected_code': 200,
                'expected_request': {}}],
        'relevance': None}  # 解析处理的
    _host = '${test_platform}$'  # 解析处理的
    _relevance = {
        'project_name': '9',
        'token': 'ccbd8e57dd064513ad6df39aad0589b5',
        'version': 'ByTQF7Zmaz',
